...
export default function NfseList() {
    ...
    // Apply all filters
    // ⚡ Bolt: Use useMemo to prevent expensive filtering, mapping and reducing operations
    // on `groupedNfs` during every re-render (e.g. when toggling expanded states).
    ...
    // ⚡ Bolt: Use useMemo to prevent recounting flags across all data on every render.
