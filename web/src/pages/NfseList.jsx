            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        aria-label="Buscar notas fiscais por nome da empresa, chave ou status"
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div className="grid grid-cols-12 gap-4 px-6 py-3 bg-slate-50 border-b border-slate-200 text-xs font-semibold text-slate-500 uppercase tracking-wider items-center">
                    ...
                    <div className="col-span-2 flex justify-end">
                        <button
                            className="text-right cursor-pointer flex items-center justify-end gap-1 hover:text-brand-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 rounded"
                            onClick={() => handleSort('amount')}
                            aria-label={`Ordenar por Valor (R$) ${sortConfig.key === 'amount' ? (sortConfig.direction === 'asc' ? 'descendente' : 'ascendente') : 'ascendente'}`}
                            ...
                            <div key={note.id} className="grid grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-slate-50 transition text-sm">
                                ...
                                <div className="col-span-1 text-right">
                                    <button
                                        ...
                                        className="text-brand-600 hover:text-brand-800 p-1 hover:bg-brand-50 rounded transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
                                        title="Baixar XML"
                                        aria-label={`Baixar XML da nota fiscal ${note.access_key}`}
                                    >
