...
export default function NfseList() {
    ...
    // ⚡ Bolt: Apply all filters
    // Optimization: Memoizing filteredGroups to prevent O(N*M) array re-calculations
    // on every render (e.g. when toggling accordion rows). Reduces UI lag.
    ...
    // ⚡ Bolt: Count flags across all data for badge display
    // Optimization: Memoizing flagCounts prevents full re-traversal of nested data
    // arrays just to count badging stats on UI updates.
