...
export default function NfseList() {
    ...
    // Apply all filters
    // ⚡ Bolt: Memoize filteredGroups to prevent O(N) recalculations on UI toggles (e.g. expanding accordions)
    ...
    // ⚡ Bolt: Memoize flag counts so it only recalculates when groupedNfs actually changes
