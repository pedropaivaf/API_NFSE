...
export default function NfseList() {
    ...
    // Apply all filters
    // ⚡ Bolt: Memoized derived state to prevent O(N) recalculations on every render
    // when expanding/collapsing lists or typing in search.
    ...
    // ⚡ Bolt: Memoized counting operation to avoid O(N) reduce on every render.
