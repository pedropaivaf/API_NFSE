...
export default function NfseList() {
    ...
    // ⚡ Bolt: Memoize the sorted list to prevent expensive re-sorting on every render
    ...
    // ⚡ Bolt: Memoize the filtered list to avoid re-filtering when unrelated state changes
