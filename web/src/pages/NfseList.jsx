...
export default function NfseList() {
    ...
    // Apply all filters
    // ⚡ Bolt Optimization: Memoize expensive filtering and mapping operations.
    // Prevents O(N) recalculation across all companies and notes on unrelated state changes (e.g., toggling accordions).
    // Performance impact: Significantly reduces render time and CPU usage when interacting with the UI, especially with thousands of notes.
    ...
    // ⚡ Bolt Optimization: Memoize total counts calculation.
    // Prevents O(N) recalculation of totals when typing in the search bar or toggling accordions.
    // Performance impact: Eliminates redundant loop over all notes on every render, improving search responsiveness.
